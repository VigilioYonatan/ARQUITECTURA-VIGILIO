...
export class DrizzleExceptionFilter extends BaseExceptionFilter {
    private readonly logger = new Logger(DrizzleExceptionFilter.name);
        ...
        // 1. DESEMPAQUETAR EL ERROR (Más agresivo)
        ...
        switch (code) {
            ...
            case "22001": {
                ...
                status = HttpStatus.BAD_REQUEST;
                message =
                    "El texto enviado es demasiado largo para este campo.";
                break;
            }
            case "22P02": {
            ...
            case "42703": {
                ...
                message =
                    "Error interno: Columna no encontrada en base de datos.";
                break;
            }
            default:
