import { EyeIconSolid, EyeSlashIconSolid } from "@vigilio/react-icons";
...
function EditorPreview({
    ...
    return (
        ...
        >
            ...
            <div className="sticky top-0 z-20 flex justify-end p-2 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 ">
                <Button
                    variant="outline"
                    size="sm"
                ...
                >
                    {isShowPreview ? (
                        <>
                            <EyeSlashIconSolid className="w-[20px] h-[20px]" />
                            Ocultar
                        </>
                    ) : (
                        <>
                            <EyeIconSolid className="w-[20px] h-[20px]" />
                            {buttonTitle}
                        </>
                    )}
                </Button>
            ...
            {/* Contenido */}
            <div
                className={`all-initial mce-content-body relative ${
                    !isShowPreview
