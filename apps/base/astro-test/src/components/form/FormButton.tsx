import { cn, normalizarText, sizeIcon } from "@infrastructure/libs/client/helpers";
import { useSignal } from "@preact/signals";
import { MagnifyingGlassIconSolid } from "@vigilio/react-icons";
...
function FormButton<T extends object>({
    name,
    title,
    required,
    values,
    ...
    return (
        <div class="space-y-2 w-full">
            ...
            <div class={cn("relative ", containerClassName)}>
                {showButtonSearch && (
                    <Card className="absolute top-0 right-10 flex !flex-row gap-2 items-center p-2 group ">
                        <button
                            type="button"
                        ...
                        >
                            <MagnifyingGlassIconSolid {...sizeIcon.medium} />
                        </button>
                    ...
                    return (
                        <button
                            ...
                            onClick={() => {
                                setValue(
                                    name,
                                    icon.key as PathValue<T, Path<T>>
                                );
                            }}
                        >
