...
export function FormFile<T extends object>({
    ...
    const handleFilesAdded = (incomingFiles: File[]) => {
        ...
        uploadFiles(filesToProcess, (uploadedKeys) => {
            ...
            if (multiple) {
                ...
                const prev = Array.isArray(currentFormValues)
                    ? currentFormValues
                    : [];
    ...
    const handleRemove = (fileState: FileState) => {
        // 1. Quitar de la lista visual (Hook)
                                        ...
                                        <div className="mt-1.5 flex items-center gap-2 h-4">
                                            ...
                                            {fileState.status ===
                                                ...
                                                <div className="flex items-center gap-2 text-blue-600">
                                                    <span className="animate-spin h-3 w-3 border-[1.5px] border-current border-t-transparent rounded-full" />
